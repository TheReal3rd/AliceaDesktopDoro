...
@onready var coinTest = load("res://Scenes/DevelopmentScenes/3DCoinTest/3DCoin.tscn")
...
func _on_d_coint_test_pressed() -> void:
	get_tree().root.add_child(coinTest.instantiate())
